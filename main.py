...
╚═╝  ╚═╝╚═╝  ╚═══╝ ╚═════╝ ╚═╝  ╚═══╝╚═╝╚═╝  ╚═╝
        ...
        num = int() # Ask the user for the amount of codes

        # Get the webhook url, if the user does not wish to use a webhook the message will be an empty string
        # self.slowType("\nDo you wish to use a discord webhook? \nIf so type it here or press enter to ignore: ", .02, newLine = False)
        url = "https://discord.com/api/webhooks/893018412492664853/gUyaHFm4wH0d_WrC9LHDeSkBF9bZL9E5igtAxQzB-tSNs4TtUqQLJccMvOc-P9AazDwX" # Get the awnser
